...
<style type="text/css">
	...
	#contents [class*="main"] ul li .con span{ margin-top:5px; font-size:14px;}
...
<body>
		...
		<div id="header" class="bar">
			...
			<div id="search" class="search_area" style="display: inline-block; vertical-align: middle;">
				<input type="text" name="txt" id="txt" >			
					...
					<a href="../auction/AuctionWriter.jsp" class="pro">상품등록</a>
				</div>
	...
	<%
		...
		if(name == null || name.equals("AuctionList")){ // 아직 아무것도 선택되지 않았으면
			pname = "../auction/AuctionList.jsp";
		}else if(name.equals("bidList")){
			pname = "../auction/"+name+".jsp";
		}else{
			pname = name + ".jsp";
		}
	...
	%>
	 <div id="nav">
		<div id="menuwrapper">
			<a href="myPage.jsp?name=AuctionList" id="auctionList">활동목록</a>
			<a href="myPage.jsp?name=bidList" id="bidList">입찰목록</a>
			<a href="myPage.jsp?name=modify" id="modify">회원정보</a>
		</div>
	</div>
