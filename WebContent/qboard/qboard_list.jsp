...
<body>
	<div id="body">
		<div id="header" class="bar">
			...
			<div id="search" class="search_area" style="display: inline-block; vertical-align: middle;">
             ...
             <div id="nav">
				<div id="menuwrapper">
					<a href="/Project/qboard/qboard_list.jsp">문의 게시판</a>
					<a href="#"></a>
					<a href="#"></a>
				</div>
			</div>
	...
	<div id="container">
		<table>
			...
			<%
				ArrayList<QBoardVO> list = dao.getAllData();
			...
			%>
			<tr>
				<td class="title"><a href="qboard_detail.jsp?qno=<%=vo.getQno()%>"><%=vo.getQtitle() %></a></td>
				<td class="writer"><%=vo.getId() %></td>
				<td class="date"><%=vo.getQdate() %></td>
			</tr>	
			...
			<div id="pagelist">
				...
				%>
				<a href="qboard_list.jsp?cp=<%=i %>"><span id="page"><%=i %></span></a>
				<%
						} // if end
					} // for end
				%>
		...
		<div>
			<div class="btn">
				<a href="qboard_write.jsp"><button>글쓰기</button></a>
			</div>
		</div>
	</div>
