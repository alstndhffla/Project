...
<%-- <%--     			location.href = "AuctionDeleteOk.jsp?bno=<%=vo.getBno()%>"; --%> --%>
//     			}else{
						...
						<li>
							<div class="con">
								...
								<form action="AuctionModifyOk.jsp" method="post" name="AuctionModifyOk" id="AuctionModifyOk" enctype="multipart/form-data">
									<input type="hidden" name="ano" id="ano" value="1" />
									<div class="con6">
									<h2>카테고리를 선택하세요</h2>
									<br />
...
<!-- 										  <form id="form1" runat="server"> -->
										      <img name = "im" id="blah" src="C:\Users\UserK\web_workspace\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\Project\upload\<%=vo.getImgpath() %>" alt="상품이미지" />
<!-- 										 </form> -->
										  <br />
										  <br />
									...
									<div class="btn-box">
										...
										<input type="submit" value="물품 수정" class="btnitem"/></a>
